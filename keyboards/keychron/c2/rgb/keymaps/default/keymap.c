...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [WIN_FN] = LAYOUT_fullsize_ansi( \
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_TASK,  KC_FLXP,   BL_INC,   BL_DEC,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_SNIP,  _______,  RGB_TOG,                                        \
    ...
    */
    ...
    [MAC_FN] = LAYOUT_fullsize_ansi( \
        KC_ESC,             KC_BRID,  KC_BRIU,  KC_MSSN,  KC_FIND,   BL_INC,   BL_DEC,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  KC_MSNP,  _______,  RGB_TOG,                                        \
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,  _______,  _______,  _______, \
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,  _______,  _______,  _______, \
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,                               _______,  _______,  _______,           \
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,           _______,  _______,  _______,  _______, \
